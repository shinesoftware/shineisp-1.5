                ...
                'resolver_configs' => array(
                        ...
                        'collections' => array(
                                'js/administration.js' => array(
                                        ...
                                        'commons/js/bootstrap-select.min.js',
                                        'commons/js/jquery.tokenize.js',
                                        'commons/js/fileinput.min.js',
                                        'js/product-admin.js',
                                ),
                                'css/application.css' => array(
                                        'css/product.css',
                                ...
                                'css/administration.css' => array(
                                        ...
                                        'commons/css/fileinput.min.css',
                                        'commons/css/bootstrap-select.css',
                                        'commons/css/bootstrap-switch.min.css',
                                        'commons/css/jquery.tokenize.css',
